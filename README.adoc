...
=== About the BES
Technical link:https://opendap.github.io/technical/bes-intro.html[documentation about the BES]
...
(files, databases, Wen Object Stores, etc.) and return both DAP2/4 and file format responses.
