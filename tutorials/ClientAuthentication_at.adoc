...
* _**cURL**_ (a.k.a. _lib_curl_ or _curl_)
* _**ncdump**_ and _**nccopy**_ - `ncdump` and `nccopy` utilize the NetCDF-C library to
access DAP resources so
...
Add your EDL credentials to the _.netrc_ file, associating them with the
