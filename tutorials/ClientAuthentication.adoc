...
image::../images/UrsApplicationSearch.png[Earthdata Login Approve Applications Page]
...
image::../images/EDL-Approve-Applications.png[Earthdata Login Application Approval Page, 640,480,pdfwidth=50%,scaledwidth=50%]
...
image::../images/UrsApprovedApplicationList.png[Earthdata Login Approved Applications]
