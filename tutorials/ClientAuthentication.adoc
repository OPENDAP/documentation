...
image::../images/UrsApproveApplication.png[Earthdata Login Application Approval Page]
...
image::../images/IDVAuthDialog.png[IDV URS Authentication Dialog]
...
image::../images/ToolsUIAuthDialog.png[ToolsUI URS Authentication Dialog]
...
image::../images/PanoplyAuthDialog.png[Panoply URS Authentication Dialog]
