= image:OPeNDAP-Logo-red.svg[width=350] User Guide
...
:hyrax-doc: https://opendap.github.io/hyrax_guide/Master_Hyrax_Guide.html
:hyrax-bes-conf-doc: https://opendap.github.io/hyrax_guide/Master_Hyrax_Guide.html#bess-configuration
:hyrax-olfs-conf-doc: https://opendap.github.io/hyrax_guide/Master_Hyrax_Guide.html#OLFS-config
:hyrax-thredds-conf-doc: https://opendap.github.io/hyrax_guide/Master_Hyrax_Guide.html#THREDDS-config
:hyrax-multi-bes-doc: https://opendap.github.io/hyrax_guide/Master_Hyrax_Guide.html#config-hyrax-mult-BESs
...
WARNING: This guide mostly describes the https://zenodo.org/records/10794666[DAP2.0 protocol], an older protocol that has been superseeded by the https://opendap.github.io/dap4-specification/DAP4.html[DAP4 protocol]. The DAP4 protocol is a mature data model that can handle broader data types and container types compared to DAP2. Moreover, out DAP4 Hyrax data server provides S3 support. We are working on improving this guide. The https://opendap.github.io/documentation/QuickStart.html[QuickStart Guide] contains broad but useful information about the two distinct DAP protocols.
...
image::Unlinked.png[align="center"]
...
Hyrax can be installed in three distinct ways:

. https://opendap.github.io/hyrax_guide/Master_Hyrax_Guide.html#dockerhub[Docker Installation (Recommended)]

. https://opendap.github.io/hyrax_guide/Master_Hyrax_Guide.html#binariesLinux[(pre-compiled) Linux binaries]

. https://opendap.github.io/hyrax_guide/Master_Hyrax_Guide.html#source[Buiding from Source (Github)]

We strongly recommend using the Docker installation approach for installing Hyrax as it involves  two simple steps that, in combination, take less that 1 minute install and run Hyrax data server. Such installation can be deployed on the cloud, or a local Linux (RHEL8) or OSX (macOS) desktop computer. For more details on the installation process we referr to the https://opendap.github.io/hyrax_guide/Master_Hyrax_Guide.html#Download_and_Install_Hyrax[Hyrax Guide]


After the installation process, there are several configuration options that you will need
to address by installing software on your computer and by editing the
link:{hyrax-bes-conf-doc}[Hyrax configuration file], called `site.conf`. Details of these options are in the Hyrax documentation, but following are the decisions you'll have to make:
...
applications with lots of download steps. Pydap is a backend engine to the popular
xarray package, which means learning about pydap's best practices will help
better understand best practices for using xarray for accessing OPeNDAP servers. 

For more information about pydap, including tutorials, go to the https://pydap.github.io/pydap/[Pydap documentation site].
